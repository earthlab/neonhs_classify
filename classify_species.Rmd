...
# train RF model using the optimal parameters 
...
# predict species using validation set
#p <- predict(rf_classifier_species, valid_data, type = "class")
...
```{r randomForest_train_confMatrix, fig.width=14, fig.height=14, message=FALSE}
...
```{r randomForest_varImpPlot_ggplot, fig.height=8, fig.width=10}
